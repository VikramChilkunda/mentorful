		...
		<div className='bg-main bg-cover h-screen'>
			<div className='h-full bg-black/40'>
				<div className='max-w-lg md:mx-auto mx-10 pt-10'>
                    <p className="text-3xl font-bold text-white mb-10 text-center">Please enter your feedback of the website or any bugs you may have experienced: </p>
					<div className="relative z-0 w-full mb-6 group ">
						...
						<textarea onChange={textChange} className="border-2  p-5 block w-full text-sm text-white bg-transparent border-b-2 border-gray-300 appearance-none 
						focus:outline-none focus:ring-0 peer" value={text} />
					</div>
